...
const mongoPokerDatadb = {
    ...
    withAuthDbDetails: {
        ...
        authDb: "admin",
        host: process.env.MONGO_HOST || "192.168.0.138",
        port: 27017,
    ...
    WithOutAuthDbDetails: {
        ...
        password: "",
        authDb: "",
        host: process.env.MONGO_HOST || "192.168.1.139",
        port: 27017,
        authMechanism: "SCRAM-SHA-1",
        database: 'user_details',
        connectionLimit: 100,
...
module.exports = {
    ...
    cardplayDb: {
        host: process.env.MYSQL_HOST || '192.168.0.158',
    ...
    redis: {
        host: process.env.REDIS_HOST || '192.168.0.158',
        port: '6379'
    },
    apiRedis: {
        host: process.env.API_REDIS_HOST || '192.168.0.158',
        port: '6379'
    },
    mongoUrl: createMongoUrl(mongoPokerDatadb),
    segmentation_api: process.env.API_HOST || `http://192.168.0.158:3101`,
    ...
    rabbitmq: {
        ...
        hostname: process.env.RABBITMQ_HOST || '192.168.0.222',
        port: '5672'
    },
    promocodeArray: [
    ...
    WebengageSchedulerTime: process.env.WEBENGAGE_SCHEDULER_TIME || 15
};